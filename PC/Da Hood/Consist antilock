...
local Window = Library:CreateWindow("CONSIST WAS HERE", Vector2.new(550, 605), Enum.KeyCode.RightControl)
...
notify("CONSIST ARTIC",Color3.fromRGB(255, 255, 255),2,false)
--< Velocity Stats >--
